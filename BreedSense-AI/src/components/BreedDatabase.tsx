...
import { Search, Filter, MapPin, Heart, AlertTriangle, Info, Sliders, Users, Shield, Scale } from 'lucide-react';
...
export function BreedDatabase() {
  ...
  const cattleCount = breeds.filter(breed => breed.category === 'cow').length;
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
              <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                ...
                <SelectContent className="bg-card border-green-500/30">
                  ...
                  <SelectItem value="cow">{t('filter.cattle')}</SelectItem>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <ul className="space-y-1 text-sm">
                            <li><span className="font-medium text-green-900">Colors:</span> <span className="text-muted-foreground">{breed.characteristics.color.join(', ')}</span></li>
                            <li><span className="font-medium text-green-300">Horn Size:</span> <span className="text-muted-foreground capitalize">{breed.characteristics.hornSize}</span></li>
                            <li><span className="font-medium text-green-300">Body Size:</span> <span className="text-muted-foreground capitalize">{breed.characteristics.bodySize}</span></li>
                          </ul>
                          <div>
                          </div>
